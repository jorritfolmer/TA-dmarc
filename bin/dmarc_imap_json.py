...
import input_module_dmarc_imap_json as input_module
...
'''
    ...
    Add your modular input logic to file input_module_dmarc_imap_json.py
'''
class ModInputdmarc_imap_json(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputdmarc_imap_json, self).__init__("ta_dmarc", "dmarc_imap_json", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputdmarc_imap_json, self).get_scheme()
        scheme.title = ("DMARC mailbox (JSON output)")
...
if __name__ == "__main__":
    exitcode = ModInputdmarc_imap_json().run(sys.argv)
    sys.exit(exitcode)
